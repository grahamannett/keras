...
class SequenceDataGen:
    ...
    vocab from:
        ...
        https://github.com/braingineer/ikelos/blob/master/ikelos/data/data_server.py
    ...
    def gen_possible_indices(self, X):
        ...
        idxes = list(range(0, X.shape[0] - last_window, self.x_step))
        if self.shuffle:
    ...
    def _flow_batch(self, data, seed=None):
        ...
        while idxes_:
            ...
            yield [self.generate_x_y(data, b) for b in batch_]
